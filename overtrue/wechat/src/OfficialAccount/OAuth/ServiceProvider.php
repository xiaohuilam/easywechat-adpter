...
class ServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        $app['oauth'] = function ($app) {
            $socialite = (new Socialite(['wechat' => ['client_id' => $app['config']['app_id'], 'client_secret' => $app['config']['secret'], 'redirect' => $this->prepareCallbackUrl($app)]], $app['request']))->driver('wechat');
