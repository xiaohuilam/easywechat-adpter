...
class Application extends MiniProgram
{
    ...
    public function __construct($config = [], $prepends = [])
    {
        ...
        $providers = [AggregateServiceProvider::class, Code\ServiceProvider::class, Domain\ServiceProvider::class, Account\ServiceProvider::class, Setting\ServiceProvider::class, Tester\ServiceProvider::class];
